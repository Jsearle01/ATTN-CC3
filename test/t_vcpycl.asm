...
RESULT_BITS     EQU     SCRATCH_BASE+4          ; 1B: bit N set if test N passed
LAST_FAIL_ID    EQU     SCRATCH_BASE+5          ; 1B: ID of last-failed test ($FF if none)
CUR_TEST_ID     EQU     SCRATCH_BASE+6          ; 1B: currently-executing test ID
DEC_BUF         EQU     SCRATCH_BASE+$30        ; 5B: decimal conversion scratch
DEC_DTEMP       EQU     SCRATCH_BASE+$36        ; 2B
DEC_SCRPTR      EQU     SCRATCH_BASE+$38        ; 2B

* -------- Test data buffers --------
SRC_BUF         EQU     SCRATCH_BASE+$60        ; 40B source buffer
DST_BUF         EQU     SCRATCH_BASE+$90        ; 40B destination buffer
